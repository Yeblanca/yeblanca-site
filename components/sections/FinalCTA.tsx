...
export function FinalCTA() {
  ...
  return (
    <section className="relative bg-[#050505] overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 py-32 md:py-40 relative z-10">
        {/* Label */}
        ...
        {/* Massive heading */}
        <h2 className="font-sans font-bold text-[clamp(2.8rem,8vw,6.5rem)] tracking-[-0.05em] text-[#E6E6E6] leading-[0.9] mb-8 max-w-4xl">
          {t('final_cta_heading')}
        </h2>

        {/* Subtext */}
        <p className="text-[0.95rem] text-[rgba(232,232,232,0.4)] max-w-md mb-14 leading-relaxed">
          {t('final_cta_sub')}
        </p>
        ...
        <div className="mt-24 w-full h-px bg-[rgba(232,232,232,0.06)]" aria-hidden="true" />
      </div>
    </section>
  )
}